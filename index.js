...
function Displayprod(products,ind,lastIndex){
        ...
        for(var i = ind; i < lastIndex; i++) {
            ...
            productDiv.setAttribute("class","pcard")
...
function Displayprod2(products,ind,lastIndex){
    ...
    for(var i = ind; i < lastIndex; i++) {
        ...
        productDiv.append(image,title,price,Prescription,add);
        document.querySelector(".product-1").append(productDiv);
    }
    
    document.querySelector(".product-1").append(document.querySelector(".product-link-right"));
}
